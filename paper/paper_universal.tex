...
%  Two-column ACL-style, A4. Times font. Single-column references.
%  Designed to render cleanly at 100%; no overlapping floats; no
%  overfull boxes; no orphan/widow headings; URL breaks cleanly.
% =====================================================================
\documentclass[11pt,a4paper,twocolumn]{article}

% ---------- geometry: matches ACL/EMNLP visual feel ----------
\usepackage[a4paper,
            top=1.0in,
            bottom=1.05in,
            left=0.75in,
...
% ---------- core packages ----------
\usepackage{microtype}                     % tighter character protrusion
\usepackage{amsmath,amssymb}
\usepackage{mathptmx}                      % Times-equivalent for body + math
...
\usepackage{flushend}                      % balance columns where needed
\usepackage{stfloats}                      % full-width floats may go bottom
\usepackage{authblk}
\usepackage{ragged2e}

% ---------- prevent overflow / orphans / widows / overfull boxes ----------
...
\hbadness=10000
\vbadness=10000
\flushbottom                                % equal-height columns

% ---------- url breaking ----------
\renewcommand{\UrlFont}{\small\ttfamily}
\Urlmuskip=0mu plus 1mu

% ---------- CJK font (Noto Serif CJK SC ships with Overleaf) ----------
...
% Prevent orphan headings: section title must stay with at least 3 lines below
...
% Custom column types: ragged narrow CI columns (no line-overflow)
...
% ---------- title block ----------
\title{\bfseries\large
  Decomposing Radical-Aligned Geometry in\\[1pt]
...
\author{%
  \normalsize\textbf{Aryan Maity}\\[1pt]
  \footnotesize B.Tech Computer Science, St.\ Edmunds College (NEHU), India\\[-1pt]
  \footnotesize \texttt{aryanmaity3579@gmail.com}\\[-1pt]
...
% ---------- Table 1: full-width, top of page ----------
\begin{table*}[t!]
\centering
...
% ---------- Table 2: full-width, top of page ----------
\begin{table*}[t!]
\centering
...
\begin{tabular}{lcccc}
\toprule
\textbf{Model} & $\overline{\Delta}$ & \textbf{95\% CI} & $\bm{p}$ & \textbf{top-1}\\
\midrule
...
% =====================================================================
% References (single column for readability)
% =====================================================================
\onecolumn
\section*{References}
